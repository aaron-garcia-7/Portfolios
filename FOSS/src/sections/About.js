...
import portrait2 from "../images/photos/portrait2.jpg";
    ...
    <StyledAbout ref={ref}>
      ...
      <div className="textArea bioDiv">
        ...
        {inView && (
          <p>
            ...
            <span className="bodyText">
              based out of SLC, UT. I love technology and enjoy buildling
              user-friendly apps. Outside of tech, I love spending time with my
              wife, studying Spanish, <br className="hideBr" /> &amp; playing
              the piano.
            </span>
          </p>
        )}
      </div>
      <div className="textArea skillsDiv" ref={ref2}>
        {inView && <h4>Skills</h4>}
        {inView && (
          <p>
            <span className="bodyText">
      ...
      {inView && (
        <figure>
          ...
          <img src={portrait2} alt="Aaron Garcia" className="portrait" />
        </figure>
      )}
    </StyledAbout>
  );
  ...
  figure {
    ...
    .portraitBorder {
      ...
      .portraitStroke {
        ...
        animation: draw 2.4s ease-in forwards;
      }
    }
    .portrait {
      width: 100%;
