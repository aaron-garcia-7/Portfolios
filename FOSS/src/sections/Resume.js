...
const Resume = () => {
  ...
  return (
    <StyledResume ref={ref1}>
      ...
      {inView1 && (
        <a href={pdf} target="_blank" rel="noreferrer" className="pdfBtn">
          <span className="pdfBtnText">Download PDF</span>
        </a>
      )}
      {inView1 && (
        <article className="resume">
          {inView1 && (
            <header>
              <div className="left">
                <h2 className="fullName">Aaron Garcia</h2>
                <h4 className="role">&lt;/&gt; Client-Side Developer 💻</h4>
                <h4 className="role">User Experience Designer 💡</h4>
              </div>
              <div className="right">
                <a
            ...
            <div className="skills">
              ...
              <div className="content">
                <div className="left">
                  ...
                  <p>React Router, Framer Motion, GSAP</p>
                  <p>NPM &amp; GitHub</p>
                </div>
                <div className="right">
                  <p>Design Strategy</p>
...
const StyledResume = styled("section")`
  ...
  .pdfBtn {
    ...
    top: 7.2rem;
    right: 18%;
    padding: 0.4rem calc(0.6rem + 0.4vw);
    ...
    animation: pdfBtn 1s ease 1.2s forwards;
    .pdfBtnText {
      opacity: 0;
      color: white;
      ...
      animation: pdfBtnText 0.6s ease 1.6s forwards;
    }
    &:hover {
  ...
  .resume {
    ...
    /* background: #19303c; */
    animation: addBackground 0.8s ease 1.6s forwards;
    > * {
      margin-bottom: 6rem;
    }
    header {
    ...
    &::after {
      ...
      height: 100%;
      background: var(--col2);
      animation: resumeReveal 1.4s linear 0.4s forwards;
    }
    &::before {
      left: -1rem;
    }
