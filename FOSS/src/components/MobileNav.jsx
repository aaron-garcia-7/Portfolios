...
import { toggleScroll } from "../reducers/lockScrollReducer";
...
const MobileNav = () => {
    ...
    const socialLinkList = socialMediaData.map((obj, index) => (
        <a href={obj.src} target="_blank" rel="noreferrer" key={index} className="link">
    ...
    return (
        <StyledMobileNav style={navOpen ? activeStyle : hiddenStyle}>
            ...
            <a href="mailto:aaronegarcia1@gmail.com" className="contact">Contact</a>
        </StyledMobileNav>
    )
}
...
const StyledMobileNav = styled('nav')`
    ...
    .contact {
        ...
        &::before {
            ...
            height: 2px;
            background: var(--col1);
            animation: contactLine 0.6s ease 2.4s forwards;
        }
        &::after {
            animation-delay: 1.2s;
        }
